...
const EXPAND_INSPECTOR_STRING = "Expand inspector";
// TODO: L10N
// L10N.getStr("expandInspector");
const COLLAPSE_INSPECTOR_STRING = "Collapse inspector";
// TODO: L10N
// L10N.getStr("collapseInspector");
...
var InspectorView = {
  ...
  initialize: function () {
    ...
    for (let $el of $$("#audio-node-toolbar toolbarbutton")) {
      $el.addEventListener("click", this._onCommandClick);
    }
  ...
  destroy: function () {
    ...
    for (let $el of $$("#audio-node-toolbar toolbarbutton")) {
      $el.removeEventListener("click", this._onCommandClick);
    }
